...
public class main {
    public static int firsttrain=80;
    public static int secondtrain=40;
    public static int thirdtrain=60;
    ...
    public static void main(String[] args) {
        ArrayList<String> station = new ArrayList<>(List.of("Patna","Jaipur","Delhi","Mumbai"));
        System.out.println("\t\t\t\t\t\t\t ***************************");
        ...
        while(loop) {
            ...
            System.out.println(ANSI_BLUE_BACKGROUND+ANSI_BLACK+"Available Train between Station :                              "+ANSI_RESET);
            System.out.println(ANSI_BLUE_BACKGROUND+ANSI_BLACK+"*****************************************************************************"+ANSI_RESET);
            System.out.println(ANSI_GREEN+"Train Name\t\t\t" + "Time\t\t\t" + "Passenger Strength\t\t\t" + "Train Number");
            System.out.println("Mumbai-Nagpur\t\t" +  "2:05\t\t\t\t\t" + firsttrain + "\t\t\t\t\t1010(Mumbai Superfast)");
            System.out.println("Pune-Mumbai\t\t" + "6:00\t\t\t\t\t" + secondtrain + "\t\t\t\t\t2013(Duranto SuperFast)");
            System.out.println("Trivendram-Delhi\t\t" + "9:00\t\t\t\t\t" + thirdtrain + "\t\t\t\t\t3045(Kanyakumari EXP)"+ANSI_RESET);
            System.out.println("*****************************************************************************");
    ...
    public static void BookingFunction(int trainNum){
        try {
            ...
            if (trainNum == 1010) {
                ...
                fares.add(1000);
                trainDetails.add("Mumbai-Nagpur   13:05   Mumbai Superfast");
                firsttrain = firsttrain - 1;
            } else if (trainNum == 2013) {
                System.out.println("Ticket Price: 500");
                fares.add(500);
                trainDetails.add("Pune-Mumbai   7:00    Duranto Superfast");
                secondtrain = secondtrain - 1;
            } else {
                System.out.println("Ticket Price: 800");
                fares.add(800);
                trainDetails.add("Trivendram-Delhi    10:00      Kanyakumari EXP");
